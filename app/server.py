...
model_file_url = 'https://www.dropbox.com/s/1gcp2j9w8442bb4/stage-7_squeezenet.pth?raw=1'
model_file_name = 'model6'
...
async def setup_learner():
    ...
    data_bunch = ImageDataBunch.single_from_classes(path, classes,
        ds_tfms=get_transforms(), size=180).normalize(imagenet_stats)
    learn = cnn_learner(data_bunch, models.squeezenet1_1, pretrained=False)
